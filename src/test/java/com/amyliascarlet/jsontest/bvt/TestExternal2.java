...
public class TestExternal2 extends TestCase {
    ...
    public void test_0() throws Exception {
        ...
        Class theClass = classLoader.loadClass("com.amyliascarlet.mock.demo.service.MockDemoService");
    ...
    public static class ExtClassLoader extends ClassLoader {
        ...
        public ExtClassLoader() throws IOException{
...

            {
                ...
                super.defineClass("com.amyliascarlet.mock.demo.api.Demo", bytes, 0, bytes.length);
            }
            {
                byte[] bytes;
                ...
                super.defineClass("com.amyliascarlet.mock.demo.service.MockDemoService", bytes, 0, bytes.length);
            }
        }
    }
}
