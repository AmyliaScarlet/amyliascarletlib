...
public class Issue1496 extends TestCase {
    public void test_for_issue() throws Exception {
        ...
        assertEquals("{\"canRefuse\":true,\"code\":3,\"declaringClass\":\"com.amyliascarlet.jsontest.bvt.issue_1400.Issue1496$SetupStatus\",\"first\":false,\"last\":false,\"name\":\"FINAL_TRAIL\",\"nameCn\":\"公益委员会/理事会/理事长审核\"}", json);
    }
