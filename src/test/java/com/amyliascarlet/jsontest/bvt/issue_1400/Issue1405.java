...
import com.amyliascarlet.lib.json.support.spring.FastJsonJsonView;
...
public class Issue1405 {
    ...
    @ComponentScan(basePackages = "com.amyliascarlet.jsontest.bvt.issue_1400")
    @Configuration
    ...
    public void test7() throws Exception {
        ...
        mockMvc.perform(
                (get("/json/test1405").characterEncoding("UTF-8")
