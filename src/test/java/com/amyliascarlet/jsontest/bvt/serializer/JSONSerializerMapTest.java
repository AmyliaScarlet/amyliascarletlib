...
import com.amyliascarlet.lib.json.serializer.IntegerCodec;
...
public class JSONSerializerMapTest extends TestCase {
    ...
    public static int size(SerializeConfig config) throws Exception {
        ...
        Field nextField = Class.forName("com.amyliascarlet.lib.json.util.IdentityHashMap$Entry").getDeclaredField("next");
