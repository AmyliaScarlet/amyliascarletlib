...
public class EnumerationSeriliazerTest extends TestCase {
    ...
    public void test_2() throws Exception {
        ...
        Assert.assertEquals("{\"elements\":[{},{\"@type\":\"com.amyliascarlet.jsontest.bvt.serializer.EnumerationSeriliazerTest$Entity2\"}]}",
    ...
    public void test_4() throws Exception {
        ...
        Assert.assertEquals("{\"elements\":[{\"@type\":\"com.amyliascarlet.jsontest.bvt.serializer.EnumerationSeriliazerTest$Entity\"},{\"@type\":\"com.amyliascarlet.jsontest.bvt.serializer.EnumerationSeriliazerTest$Entity2\"}]}", JSON.toJSONString(e, SerializerFeature.WriteClassName,
                                                                        SerializerFeature.NotWriteRootClassName));
    }
