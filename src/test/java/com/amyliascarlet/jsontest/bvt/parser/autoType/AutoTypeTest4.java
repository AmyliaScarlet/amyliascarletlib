...
public class AutoTypeTest4 extends TestCase {
    ...
    public void test_4() throws Exception {
        int size = mappings.size();
        JSON.parse("{\"@type\":\"com.amyliascarlet.jsontest.bvt.parser.autoType.AutoTypeTest4$EasyThreadModel\"}", new ParserConfig());
    ...
    public void test_5() throws Exception {
        int size = mappings.size();
        JSON.parse("{\"@type\":\"com.amyliascarlet.jsontest.bvt.parser.autoType.AutoTypeTest4$Model1\"}", new ParserConfig());
    ...
    public void test_6() throws Exception {
        int size = mappings.size();
        JSON.parseObject("{\"@type\":\"com.amyliascarlet.jsontest.bvt.parser.autoType.AutoTypeTest4$Model2\"}", Model1.class);
    ...
    public void test_7() throws Exception {
        int size = mappings.size();
        JSON.parse("{\"@type\":\"com.amyliascarlet.jsontest.bvt.parser.autoType.AutoTypeTest4$Model3\"}", Feature.SupportAutoType);
    ...
    public void test_8() throws Exception {
        ...
        JSON.parse("{\"@type\":\"com.amyliascarlet.jsontest.bvt.parser.autoType.AutoTypeTest4$Model4\"}", config, JSON.DEFAULT_PARSER_FEATURE);
    ...
    public void test_9() throws Exception {
        ...
        JSON.parse("{\"@type\":\"java.lang.Class\",\"val\":\"com.amyliascarlet.jsontest.bvt.parser.autoType.AutoTypeTest4$Model5\"}", config);
    ...
    public void test_10_ser() throws Exception {
        String f2 = "{\"value\":{\"@type\":\"com.amyliascarlet.jsontest.bvt.parser.autoType.AutoTypeTest4$Model3\"}}";
    ...
    public void test_3_obj() throws Exception {
        String f2 = "{\"@type\":\"com.amyliascarlet.jsontest.bvt.parser.autoType.AutoTypeTest4$Model7\"}";
