...
public class TypeUtilsTest_castToJavaBean extends TestCase {
    protected void setUp() throws Exception {
        ParserConfig.global.addAccept("com.amyliascarlet.jsontest.bvt.parser.TypeUtilsTest_castToJavaBean.");
    }
    ...
    public void test_loadClass_1() throws Exception {
        ...
        try {
            Assert.assertEquals(VO.class,
                                TypeUtils.loadClass("com.amyliascarlet.jsontest.bvt.parser.TypeUtilsTest_castToJavaBean$VO"));
        } finally {
