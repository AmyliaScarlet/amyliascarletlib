...
public class AbstractSerializeTest extends TestCase {
    protected void setUp() throws Exception {
        ParserConfig.global.addAccept("com.amyliascarlet.jsontest.bvt.bug.AbstractSerializeTest");
    ...
    public void test_mapping_0() throws Exception {
        String text = "{\"@type\":\"com.amyliascarlet.jsontest.bvt.parser.deser.AbstractSerializeTest$A\"}";
    ...
    public void test_mapping_1() throws Exception {
        String text = "{\"@type\":\"com.amyliascarlet.jsontest.bvt.parser.deser.AbstractSerializeTest$A\",\"id\":123}";
    ...
    public void test_mapping_2() throws Exception {
        String text = "{\"@type\":\"com.amyliascarlet.jsontest.bvt.parser.deser.AbstractSerializeTest$A\",\"id\":234,\"name\":\"abc\"}";
