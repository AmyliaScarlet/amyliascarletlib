...
public class WriteDuplicateType extends TestCase {
    ...
    public void test_dupType() throws Exception {
        ...
        obj.put("id", 1001);
        obj.put(JSON.DEFAULT_TYPE_KEY, "com.amyliascarlet.jsontest.bvt.writeClassName.WriteDuplicateType$DianDianCart");
        cartMap.put("1001", obj);
        
        String text1 = JSON.toJSONString(cartMap, SerializerFeature.WriteClassName);
        Assert.assertEquals("{\"@type\":\"java.util.LinkedHashMap\",\"1001\":{\"@type\":\"com.amyliascarlet.jsontest.bvt.writeClassName.WriteDuplicateType$DianDianCart\",\"id\":1001}}", text1);
