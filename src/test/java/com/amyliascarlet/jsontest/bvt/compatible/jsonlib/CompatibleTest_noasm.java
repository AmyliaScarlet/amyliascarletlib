package com.amyliascarlet.jsontest.bvt.compatible.jsonlib;
...
import com.amyliascarlet.lib.json.serializer.JSONLibDataFormatSerializer;
...
public class CompatibleTest_noasm extends TestCase {
    ...
    public static void assertEquals(String fastJSON, String jsonLib) {
        System.out.println("json: " + fastJSON);
        System.out.println("jsontest-log: " + jsonLib);
