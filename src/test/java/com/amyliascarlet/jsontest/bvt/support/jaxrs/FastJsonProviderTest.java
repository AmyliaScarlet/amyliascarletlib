package com.amyliascarlet.jsontest.bvt.support.jaxrs;
...
import com.amyliascarlet.lib.json.support.jaxrs.FastJsonProvider;
...
public class FastJsonProviderTest extends TestCase {
    ...
    public void test_1() throws Exception {
        ...
        Assert.assertEquals(false, provider.isReadable(String.class, String.class, null, MediaType.valueOf("applications/+jsontest")));
        Assert.assertEquals(false, provider.isWriteable(String.class, String.class, null, MediaType.valueOf("applications/x-jsontest")));
