...
import com.amyliascarlet.lib.json.support.spring.FastJsonHttpMessageConverter;
import com.amyliascarlet.lib.json.support.spring.FastJsonViewResponseBodyAdvice;
import com.amyliascarlet.lib.json.support.spring.JSONPResponseBodyAdvice;
...
public class FastJsonHttpMessageConverterCase2Test {
    ...
    @ComponentScan(basePackages = "com.amyliascarlet.jsontest.bvt.support.spring.mock.controller")
    @EnableWebMvc
    @Configuration
