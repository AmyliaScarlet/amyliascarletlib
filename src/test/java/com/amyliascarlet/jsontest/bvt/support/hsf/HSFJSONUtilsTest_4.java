...
public class HSFJSONUtilsTest_4 extends TestCase {
    public void test_for_hsf() throws Exception {
        ...
        String json = "{\"argsTypes\":[\"java.util.HashSet\",\"com.amyliascarlet.jsontest.bvt.support.hsf.HSFJSONUtilsTest_4$BigDecimalDO\"],\"argsObjs\":[[{\"bd\":10.12379}],{\"$ref\":\"$.argsObjs[0][0]\"}]}";
