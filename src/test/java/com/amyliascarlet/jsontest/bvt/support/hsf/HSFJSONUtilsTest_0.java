    ...
    protected void setUp() throws Exception {
        ...
        methodLocator = new MethodLocator() {
            public Method findMethod(String[] types) {
                ...
                if (types.length == 1 && types[0].equals("com.amyliascarlet.jsontest.bvt.support.hsf.HSFJSONUtilsTest_0.User[]")) {
                    return method_f5;
                }
...
//        System.out.println(jsontest);
    ...
    public void test_invoke_array() throws Exception {
        String json = "{\n" +
                "    \"argsTypes\": [\"com.amyliascarlet.jsontest.bvt.support.hsf.HSFJSONUtilsTest_0.User[]\"],\n" +
                "    \n" +
                "    \"argsObjs\": [\n" +
                "        [\n" +
                "    \t\t{\n" +
