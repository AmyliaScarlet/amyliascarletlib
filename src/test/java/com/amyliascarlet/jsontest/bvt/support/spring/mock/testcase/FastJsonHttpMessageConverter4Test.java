 ...
 * <p>Package: com.amyliascarlet.jsontest.bvt.support.spring.mock.testcase</p>
...
public class FastJsonHttpMessageConverter4Test {
    ...
    public void test1() throws Exception {
        ...
        mockMvc.perform(
                (post("/json/test1").characterEncoding("UTF-8").content(json.toJSONString()).contentType(MediaType.APPLICATION_JSON)
                ))
//		.andExpect(status().isOk())
    ...
    public void test2() throws Exception {
        ...
        mockMvc.perform(
                (post("/json/test2").characterEncoding("UTF-8").content(jsonStr).contentType(MediaType.APPLICATION_JSON)
                ))
//		.andExpect(status().isOk())
                .andDo(print());
    }
    ...
    public void test3() throws Exception {
        List<Object> list = this.mockMvc.perform(post("/json/test3")).andReturn().getResponse().getHeaderValues("Content-Length");
    ...
    public void test4() throws Exception {
        ...
        mockMvc.perform(
                (post("/json/test4").characterEncoding("UTF-8").content(
    ...
    public void test5() throws Exception {
        ...
        mockMvc.perform(
                (post("/json/test5").characterEncoding("UTF-8").content(
                        jsonStr).contentType(MediaType.APPLICATION_JSON)))
                .andDo(print());
    }
}
