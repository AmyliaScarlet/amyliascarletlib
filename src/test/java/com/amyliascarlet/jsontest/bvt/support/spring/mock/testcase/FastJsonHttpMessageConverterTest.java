...
public class FastJsonHttpMessageConverterTest {
    ...
    public void test1() throws Exception {
        ...
        mockMvc.perform(
                (post("/json/test1").characterEncoding("UTF-8").content(
                        json.toJSONString())
    ...
    public void test2() throws Exception {
        ...
        mockMvc.perform(
                (post("/json/test2").characterEncoding("UTF-8").content(
    ...
    public void test3() throws Exception {
        List<Object> list = this.mockMvc.perform(post("/json/test3"))
    ...
    public void test6() throws Exception {
        ...
        mockMvc.perform(
                (post("/json/test6").characterEncoding("UTF-8")
                        .param("userId", "1234")
                        .param("flag", "0")
