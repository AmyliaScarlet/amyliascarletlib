package com.amyliascarlet.jsontest.bvt.support.spring;

import com.amyliascarlet.lib.json.support.spring.GenericFastJsonRedisSerializer;
...
public class GenericFastJsonRedisSerializerTest {
    ...
    public void test_6() {
        ...
        String json = "{\n" +
                "\"@type\": \"com.amyliascarlet.jsontest.bvt.support.spring.GenericFastJsonRedisSerializerTest$BaseResult\",\n" +
                "\"code\": \"1000\",\n" +
                "\"data\": [\n" +
                "\"按手动控制按钮\",\n" +
                "\"不停机\",\n" +
