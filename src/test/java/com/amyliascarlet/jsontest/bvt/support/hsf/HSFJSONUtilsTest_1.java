package com.amyliascarlet.jsontest.bvt.support.hsf;

import com.amyliascarlet.lib.json.support.hsf.HSFJSONUtils;
import com.amyliascarlet.lib.json.support.hsf.MethodLocator;
...
public class HSFJSONUtilsTest_1 extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        methodLocator = new MethodLocator() {
            public Method findMethod(String[] types) {
                ...
                if (types[1].equals("com.amyliascarlet.jsontest.bvt.support.hsf.HSFJSONUtilsTest_0$EasyThreadModel[]")) {
                    return method_f4;
                }
    ...
    public void test_invoke() throws Exception {
        String json = "{ \n" +
                "    \"argsTypes\"  :  [ \"java.lang.String\", \"com.amyliascarlet.jsontest.bvt.support.hsf.HSFJSONUtilsTest_0$EasyThreadModel\"],\n" +
    ...
    public void test_invoke_type() throws Exception {
        String json = "{\"@type\":\"com.amyliascarlet.json.JSONObject\", \n" +
                "    \"argsTypes\"  :  [ \"java.lang.String\", \"com.amyliascarlet.jsontest.bvt.support.hsf.HSFJSONUtilsTest_0$EasyThreadModel\"],\n" +
                "    \"argsObjs\"   :   [ \"abc\", {\"value\":\"xxx\"} ]\n" +
                "}";
        Object[] values = HSFJSONUtils.parseInvocationArguments(json, methodLocator);
    ...
    public void test_invoke_array() throws Exception {
        String json = "[ \n" +
                "   [ \"java.lang.String\", \"com.amyliascarlet.jsontest.bvt.support.hsf.HSFJSONUtilsTest_0$EasyThreadModel\"],\n" +
                "    [ \"abc\", {\"value\":\"xxx\"} ]\n" +
                "]";
        Object[] values = HSFJSONUtils.parseInvocationArguments(json, methodLocator);
        assertNotNull(values);
