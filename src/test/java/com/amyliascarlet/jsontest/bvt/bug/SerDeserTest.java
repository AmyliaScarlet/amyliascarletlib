...
import com.amyliascarlet.jsontest.bvtVO.OptionKey;
import com.amyliascarlet.jsontest.bvtVO.OptionValue;
import com.amyliascarlet.jsontest.bvtVO.TempAttachMetaOption;
...
public class SerDeserTest extends TestCase {
    protected void setUp() throws Exception {
        com.amyliascarlet.lib.json.parser.ParserConfig.global.addAccept("com.amyliascarlet.jsontest.bvtVO.");
    }
    ...
    static {
        ...
        attach.setPath("http://amyliascarlet-inc.com/test.txt");
