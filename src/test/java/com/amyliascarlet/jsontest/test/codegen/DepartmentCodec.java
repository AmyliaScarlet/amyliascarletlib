...
public class DepartmentCodec extends JavaBeanDeserializer implements ObjectDeserializer {
    ...
    private Type members_gen_list_item_type__ = com.amyliascarlet.jsontest.test.codegen.Employee.class;
    private ObjectDeserializer type_gen_deser__;
    
    public DepartmentCodec (ParserConfig config, Class clazz) {
        super(config, clazz);
        type_gen_deser__ = config.getDeserializer(com.amyliascarlet.jsontest.test.codegen.DepartmentType.class);
    }
    ...
    public Object deserialze(DefaultJSONParser parser, Type type, Object fieldName) {
        ...
        int _asm_flag_0 = 0;
        int id_gen = 0;
        com.amyliascarlet.jsontest.test.codegen.Employee leader_gen = null;
        ...
        com.amyliascarlet.jsontest.test.codegen.DepartmentType type_gen = null;
                ...
                if (lexer.token() == JSONToken.NULL) {
                    ...
                    if (lexer.token() == JSONToken.LBRACKET) {
                        if(members_gen_list_item_deser__ == null) {
                            members_gen_list_item_deser__ = parser.getConfig().getDeserializer(com.amyliascarlet.jsontest.test.codegen.Employee.class);
                        }
                        ...
                        for(int i = 0; ;++i) {
                            ...
                            com.amyliascarlet.jsontest.test.codegen.Employee itemValue = members_gen_list_item_deser__.deserialze(parser, members_gen_list_item_type__, i);
        ...
        if ((!endFlag) && (!restFlag)) {
            type_gen = (com.amyliascarlet.jsontest.test.codegen.DepartmentType) this.scanEnum(lexer, type_gen_prefix__, type_gen_deser__);
            if(lexer.matchStat > 0) {
                _asm_flag_0 |= 32;
                matchedCount++;
            }
