...
public class TestASM extends TestCase implements Opcodes {
    ...
    public void test_1() throws Exception {
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, "DateSerializer", "java/lang/Object", new String[] { "com/alibaba/json/serializer/ObjectSerializer" });
        ...
        mw = new MethodWriter(cw, ACC_PUBLIC, "write", "(Lcom/amyliascarlet/json/serializer/JSONSerializer;Ljava/lang/Object;)V", null, new String[] { "java/io/IOException" });

        mw.visitVarInsn(ALOAD, 1); // serializer
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/json/serializer/JSONSerializer", "getWriter", "()Lcom/amyliascarlet/json/serializer/SerializeWriter;");
        ...
        MyClassLoader loader = new MyClassLoader(com.amyliascarlet.lib.json.serializer.ObjectSerializer.class.getClassLoader());
