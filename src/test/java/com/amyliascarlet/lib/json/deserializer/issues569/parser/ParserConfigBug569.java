...
public class ParserConfigBug569 extends ParserConfig {
    ...
    private String[]                                        denyList    = new String[] { "java.lang.EasyThread" };
    ...
    public ObjectDeserializer getDeserializer(Class<?> clazz, Type type) {
        com.amyliascarlet.lib.json.util.IdentityHashMap<Type, ObjectDeserializer> derializers = super.getDeserializers();
