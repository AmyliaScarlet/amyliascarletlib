package com.amyliascarlet.lib.json.deserializer;
...
public class IgnoreTypeDeserializer {
    ...
    public void parseObjectWithNotExistTypeThrowException() {
        String s = "{\"@type\":\"com.amyliascarlet.json.ValueBean\",\"val\":1}";
    ...
    public void parseWithExistType() {
        String s = "{\"@type\":\"com.amyliascarlet.json.deserializer.ValueBean\",\"val\":1}";
        Object object = JSONObject.parse(s);
        Assert.assertNotNull(object);
