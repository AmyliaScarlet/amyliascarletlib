 ...
 */
package com.amyliascarlet.lib.json;
...
import com.amyliascarlet.lib.json.parser.*;
...
import com.amyliascarlet.lib.json.parser.deserializer.ParseProcess;
import com.amyliascarlet.lib.json.serializer.*;
 ...
 * 
 * <p>Here is an example of how json is used for a simple Class:
 *
 * <pre>
 * EasyThreadModel model = new EasyThreadModel();
 * String jsontest = JSON.toJSONString(model); // serializes model to Json
 * EasyThreadModel model2 = JSON.parseObject(jsontest, EasyThreadModel.class); // deserializes jsontest into model2
 * </pre>
 * 
 ...
 * <pre>
 * String jsontest = "[{},...]";
 * Type listType = new TypeReference&lt;List&lt;EasyThreadModel&gt;&gt;() {}.getType();
 * List&lt;EasyThreadModel&gt; modelList = JSON.parseObject(jsontest, listType);
 * </pre>
 * 
 * @see com.amyliascarlet.lib.json.TypeReference
 * 
...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    private static void config(Properties properties) {
        {
            String featuresProperty = properties.getProperty("json.serializerFeatures.MapSortField");
     ...
     * List&lt;EasyThreadModel&gt; models = JSON.parseObject(jsonStr, new TypeReference&lt;List&lt;EasyThreadModel&gt;&gt;() {});
     * </pre>
     * @param text jsontest string
     ...
     * {@link com.amyliascarlet.lib.json.TypeReference} class. For example, to get the type for
     ...
     *
     * @param object the object for which jsontest representation is to be created setting for json
    ...
    /**
     * This method serializes the specified object into its equivalent jsontest representation.
     *
     * @param writer Writer to which the jsontest representation needs to be written
     * @param object the object for which jsontest representation is to be created setting for json
    ...
    /**
     * write object as jsontest to OutputStream
