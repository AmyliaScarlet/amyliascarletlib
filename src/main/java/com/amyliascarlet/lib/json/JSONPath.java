...
public class JSONPath implements JSONAware {
    ...
    public JSONPath(String path, SerializeConfig serializeConfig, ParserConfig parserConfig){
        if (path == null || path.length() == 0) {
            throw new JSONPathException("jsontest-path can not be null or empty");
        }
            ...
            if (lexer.token() == JSONToken.LBRACKET) {
                ...
                for (;;) {
                    ...
                    if (lexer.token() == JSONToken.RBRACKET) {
                        ...
                        throw new JSONException("illegal jsontest : " + lexer.info());
                    }
                }
...
//                        continue;
//                    } else {
//                        throw new JSONException("illegal jsontest.");
//                    }
//                }
//
//                context.object = array;
