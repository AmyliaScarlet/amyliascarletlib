...
import static com.amyliascarlet.lib.json.util.ASMUtils.desc;
import static com.amyliascarlet.lib.json.util.ASMUtils.type;
...
import com.amyliascarlet.lib.json.asm.ClassWriter;
import com.amyliascarlet.lib.json.asm.FieldWriter;
import com.amyliascarlet.lib.json.asm.Label;
import com.amyliascarlet.lib.json.asm.MethodVisitor;
import com.amyliascarlet.lib.json.asm.MethodWriter;
import com.amyliascarlet.lib.json.asm.Opcodes;
import com.amyliascarlet.lib.json.parser.DefaultJSONParser;
import com.amyliascarlet.lib.json.parser.DefaultJSONParser.ResolveTask;
    ...
    private void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitLdcInsn(com.amyliascarlet.lib.json.parser.JSONLexerBase.VALUE_NULL);
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(com.amyliascarlet.lib.json.asm.Type.getType(desc(fieldClass)));
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(com.amyliascarlet.lib.json.asm.Type.getType(desc(itemClass)));
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(com.amyliascarlet.lib.json.parser.JSONToken.LBRACKET);
                mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "nextToken", "(I)V");
...
//                mw.visitInsn(POP);
    ...
    private void _deserialze(ClassWriter cw, Context context) {
        ...
        mw.visitLdcInsn(com.amyliascarlet.lib.json.parser.JSONLexerBase.NOT_MATCH);
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETFIELD, JSONLexerBase, "matchStat", "I");
        mw.visitLdcInsn(com.amyliascarlet.lib.json.parser.JSONLexerBase.END);
...
//                mw.visitLabel(enumNull_);
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(com.amyliascarlet.lib.json.asm.Type.getType(desc(fieldClass))); // cast
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(com.amyliascarlet.lib.json.asm.Type.getType(desc(itemType)));
        mw.visitInsn(ICONST_0);
        mw.visitMethodInsn(INVOKESTATIC, "java/lang/Integer", "valueOf", "(I)Ljava/lang/Integer;");
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(com.amyliascarlet.lib.json.parser.DefaultJSONParser.NeedToResolve);
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(com.amyliascarlet.lib.json.parser.DefaultJSONParser.NONE);
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass, int i) {
        ...
        if ((fieldInfo.parserFeatures & Feature.SupportArrayToBean.mask) != 0) {
            ...
            if (fieldInfo.fieldType instanceof Class) {
                mw.visitLdcInsn(com.amyliascarlet.lib.json.asm.Type.getType(desc(fieldInfo.fieldClass)));
            } else {
                mw.visitVarInsn(ALOAD, 0);
                mw.visitLdcInsn(i);
                mw.visitMethodInsn(INVOKEVIRTUAL, type(JavaBeanDeserializer.class), "getFieldType",
