...
import com.amyliascarlet.lib.json.util.RyuDouble;
import com.amyliascarlet.lib.json.util.RyuFloat;
...
import static com.amyliascarlet.lib.json.util.IOUtils.replaceChars;
...
public final class SerializeWriter extends Writer {
    ...
    static {
        try {
            String prop = IOUtils.getStringProperty("json.serializer_buffer_threshold");
