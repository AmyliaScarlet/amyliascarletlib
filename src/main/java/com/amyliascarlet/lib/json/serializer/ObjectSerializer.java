 ...
 * you are not happy with the default serialization done by json. You will also need to register
 * this serializer through {@link com.amyliascarlet.lib.json.serializer.SerializeConfig#put(Type, ObjectSerializer)}.
 *
 * <pre>
 ...
 * String jsontest = JSON.toJSONString(result, config); // {"code":17}
 * Assert.assertEquals("{\"code\":17}", jsontest);
 * </pre>
...
public interface ObjectSerializer {
    ...
    /**
     * json invokes this call-back method during serialization when it encounters a field of the
     * specified type.
     * @param serializer 
