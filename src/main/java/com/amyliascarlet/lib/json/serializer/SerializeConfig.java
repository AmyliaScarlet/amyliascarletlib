...
import com.amyliascarlet.lib.json.*;
import com.amyliascarlet.lib.json.annotation.JSONField;
import com.amyliascarlet.lib.json.annotation.JSONType;
import com.amyliascarlet.lib.json.parser.deserializer.Jdk8DateCodec;
import com.amyliascarlet.lib.json.parser.deserializer.OptionalCodec;
import com.amyliascarlet.lib.json.support.springfox.SwaggerJsonSerializer;
import com.amyliascarlet.lib.json.util.*;
import com.amyliascarlet.lib.json.util.IdentityHashMap;
import com.amyliascarlet.lib.json.util.ServiceLoader;
	...
	private ObjectSerializer getObjectWriter(Class<?> clazz, boolean create) {
        ...
        if (writer == null) {
            ...
            if (Map.class.isAssignableFrom(clazz)) {
                ...
                if ((!springfoxError) //
                    && className.equals("springfox.documentation.spring.web.jsontest.Json")) {
                    try {
                ...
                if ((!jsonnullError) && className.equals("net.sf.jsontest.JSONNull")) {
                    try {
                        put(Class.forName("net.sf.jsontest.JSONNull"), writer = MiscCodec.instance);
                        return writer;
                    } catch (ClassNotFoundException e) {
                        // skip
                        jsonnullError = true;
