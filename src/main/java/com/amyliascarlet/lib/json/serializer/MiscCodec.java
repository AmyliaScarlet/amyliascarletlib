...
public class MiscCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    static {
        FILE_RELATIVE_PATH_SUPPORT = "true".equals(IOUtils.getStringProperty("json.deserializer.fileRelativePathSupport"));
    }
    ...
    public void write(JSONSerializer serializer, Object object, Object fieldName, Type fieldType,
        ...
        if (objClass == SimpleDateFormat.class) {
            ...
            out.write('}');
            return;
        } else if (object.getClass().getName().equals("net.sf.jsontest.JSONNull")) {
            out.writeNull();
            return;
